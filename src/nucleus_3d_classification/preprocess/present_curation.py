'''
This script was made to showcase the curation process of 3D segmentation masks using Napari.
The script to curate masks is "napari_curation_and_labelling.py" and is found in the same directory.
'''
